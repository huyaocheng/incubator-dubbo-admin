...
public class RegistryServerSyncTest {
    ...
    public void testNotify() {
        ...
        when(consumerUrl.getParameter(Constants.CATEGORY_KEY, Constants.PROVIDERS_CATEGORY)).thenReturn(com.alibaba.dubbo.common.Constants.CONSUMER_PROTOCOL);
        ...
        when(providerUrl.getParameter(Constants.CATEGORY_KEY, Constants.PROVIDERS_CATEGORY)).thenReturn(com.alibaba.dubbo.common.Constants.PROVIDER_PROTOCOL);
        ...
        ConcurrentMap<String, Map<String, URL>> consumerMap = registryServerSync.getRegistryCache().get(com.alibaba.dubbo.common.Constants.CONSUMER_PROTOCOL);
        assertTrue(consumerMap.keySet().contains("org.apache.dubbo.consumer"));
        ConcurrentMap<String, Map<String, URL>> providerMap = registryServerSync.getRegistryCache().get(com.alibaba.dubbo.common.Constants.PROVIDER_PROTOCOL);
        assertTrue(providerMap.keySet().contains("org.apache.dubbo.provider"));

        // when url.getProtocol is empty protocol
        when(consumerUrl.getProtocol()).thenReturn(com.alibaba.dubbo.common.Constants.EMPTY_PROTOCOL);
        ...
        when(providerUrl.getProtocol()).thenReturn(com.alibaba.dubbo.common.Constants.EMPTY_PROTOCOL);
